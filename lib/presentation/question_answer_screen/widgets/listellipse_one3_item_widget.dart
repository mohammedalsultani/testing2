...
class ListellipseOne3ItemWidget extends StatelessWidget {
  ListellipseOne3ItemWidget(this.listellipseOne3ItemModelObj);

  ListellipseOne3ItemModel listellipseOne3ItemModelObj;
