...
class ListellipseOne2ItemWidget extends StatelessWidget {
  ListellipseOne2ItemWidget(this.listellipseOne2ItemModelObj);

  ListellipseOne2ItemModel listellipseOne2ItemModelObj;
