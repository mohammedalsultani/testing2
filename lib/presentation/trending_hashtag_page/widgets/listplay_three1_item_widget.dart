...
class ListplayThree1ItemWidget extends StatelessWidget {
  ListplayThree1ItemWidget(this.listplayThree1ItemModelObj);

  ListplayThree1ItemModel listplayThree1ItemModelObj;
